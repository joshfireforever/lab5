...
app.get("/", async function(req, res) {
    let apiUrl = "https://api.unsplash.com/photos/random/?client_id=i5BZfw9ZHS5IuiP1hxpIcz4PzSmLY05t6VJoawwWNAY&featured=true"
...
app.get("/search", async function(req, res) {
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=i5BZfw9ZHS5IuiP1hxpIcz4PzSmLY05t6VJoawwWNAY&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
